...
## Presentation of the survey data -- TODO (change this for LIBRARY data!)
...
### Download lesson data -- TODO (change this for LIBRARY data!)
...
## Lesson Overview  -- TODO (change this for LIBRARY data!)
...
> ## Try out the methods below to see what they return. -- TODO (change this for LIBRARY data!)
>
...
# -- TODO (change this for LIBRARY data!)
...
> ## Challenge
>
> Create a list of unique plot ID's found in the surveys data.
> Call it *plot_names*. How many unique plots are there in the data? How many
> unique species are in the data?
{: .challenge}
